...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-slate-900 text-white hover:bg-slate-800 focus-visible:outline-slate-950',
        secondary:
        ...
        outline:
          'border border-slate-200 bg-white hover:bg-slate-100 hover:text-slate-900 focus-visible:outline-slate-950',
      },
      size: {
